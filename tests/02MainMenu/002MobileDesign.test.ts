...
test.skip("Verify Mobile Design Section Functionality", async ({ loginPage, MainMenu, page }) => {
...
test("MD002-03 | Validate All Image Upload Functionality", async ({ loginPage, MainMenu, page }) => {
