...
test("Verify Menu Section Functionality", async ({ loginPage, MainMenu, languagePage, menuPage, page, }, testInfo) => {
        ...
        await test.step("004M-001 | Varify Fonts Upload Functionality", async () => {
                const screenshot = await page.screenshot();
        ...
        await test.step("004M-002 | Varify First Color input functionality for menubar", async () => {
                const screenshot = await page.screenshot();
        ...
        await test.step("004M-003 | Varify Second Color input functionality for menubar", async () => {
                const screenshot = await page.screenshot();
        ...
        await test.step("004M-004 | Varify Alignment button", async () => {
                const screenshot = await page.screenshot();
        ...
        await test.step("004M-005 | Varify all the functionality for show all icon", async () => {
                const screenshot = await page.screenshot();
        ...
        await test.step("004M-006 | Verify all the uploaded icons deleted successfully", async () => {
