...
test("arcade settings related tests", async ({ MainMenu, arcadePage,menuPage, loginPage, page, },testInfo) => {
...
test("Validated Arcade Settings Logo Section", async ({ MainMenu, arcadePage,menuPage,functions, loginPage, page, },testInfo) => {
...
test("Validated Arcade Settings Settings Section", async ({ MainMenu, arcadePage,menuPage,functions, loginPage, page, },testInfo) => {
...
test("Validated Arcade outside Game Delete Functionality", async ({ MainMenu, arcadePage,menuPage,functions, loginPage, page, },testInfo) => {
